...
class Restaurants extends Place {
	...
	cuisine: string;
	url: string;
	constructor(type: string, name: string, city: string, zip: number, adress: string, img: string, created: string, tel: string, cuisine: string, url: string) {
...
class Concerts extends Place {
	...
	eventTime: string;
	price: number;
	constructor(type: string, name: string, city: string, zip: number, adress: string, img: string, created: string, eventDate: string, eventTime: string, price: number) {
		super(type, name, city, zip, adress, img, created);
